...
const overlayTransitions = [
  ...
  { color: 'rgb(0, 23, 72)', start: 61, end: 67 },
  { color: 'rgb(51, 49, 22)', start: 71, end: 77 },
  { color: 'rgb(20, 100, 90)', start: 80, end: 85 },
  { color: 'rgb(80, 13, 90)', start: 86, end: 91 },
  { color: '#000', start: 93, end: 100 },
]
...
const contentTransitions = [
  ...
  { color: 'rgba(56, 116, 130, 0.9)', start: 54, end: 56 },
  { color: 'rgba(40, 73, 98, 0.9)', start: 61, end: 67 },
  { color: 'rgba(26, 62, 119, 0.9)', start: 73, end: 75 },
  { color: 'rgba(136, 143, 61, 0.9)', start: 80, end: 85 },
  { color: 'rgba(53, 32, 126, 0.9)', start: 86, end: 90 },
  { color: 'rgba(24, 48, 70, 0.9)', start: 96, end: 100 },
]
