var _titleText = {
  ...
  b10: ["<b12>unique creative snowflake"],
  ...
  bb2: ['<bb5>an unlikely Luddite streak,'],
  bb5: ["a wandering mind,"],
  d: ['<d1>his first indie game release.'],
  d1: ["<d2>a roguelike deck-building game."],
  d2: ["<d6>using his powers for good."],
  ...
  d19: ["<d20>a Pilsner over an IPA any day."],
